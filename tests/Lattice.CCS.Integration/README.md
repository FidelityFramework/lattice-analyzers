# CCS Option projection gate

This executable checks the Option regression corpus through **CCS.Editor** in the sibling
...
The gate requires successful project loading and parsing, checks accepted dimensional Option
values and hovers, and requires the precise compiler diagnostic and source span for invalid
cases. It also checks obsolete-revision rejection, unsaved edit repair, unchanged disk source
