module Lattice.Analyzers.Tests.Suggestion.CopyAndUpdateRecordChangesAllFieldsAnalyzerTests
...
open Lattice.Analyzers.Suggestion.CopyAndUpdateRecordChangesAllFieldsAnalyzer
