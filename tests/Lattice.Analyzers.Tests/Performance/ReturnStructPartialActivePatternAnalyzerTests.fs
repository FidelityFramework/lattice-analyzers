module Lattice.Analyzers.Tests.Performance.ReturnStructPartialActivePatternAnalyzerTests

open NUnit.Framework
open FSharp.Compiler.CodeAnalysis
open FSharp.Analyzers.SDK
open FSharp.Analyzers.SDK.Testing
open Lattice.Analyzers.Performance.ReturnStructPartialActivePatternAnalyzer
